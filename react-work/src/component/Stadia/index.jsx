...
// import { students } from 'react';
import './style.css';
import './games'
import Button from '../Button';


const Stadia = ({ list, games }) => {
    ...
    return (
        ...
        <div >
            <div className="body2">
                {list.map((list, test) => {
                    return (
                        ...
                        // <div>Separate this taggssssssssss</div>
                        //     <div className="body1" key={test}>
                        //     {list.name}
                        //     {list.job}  {list.description}
                        // </div> 
            ...
            <div style={{ textAlign: 'center' }}>
                <Button text={'Try Stadia Pro free for 1 month'}  />
                <br />
            ...
            <div className="body2">
                <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_odyssey_1x.jpg" alt="" />assassinscreed_odyssey
                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_origins_1x.jpg" alt="" />assassinscreed_origins
                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_syndicate_1x.jpg" alt="" /><br />assassinscreed_syndicate
                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_unity_1x.jpg" alt="" /><br />assassinscreed_unity
                 ...
                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/AttackonTitan2_FinalBattle_1x.jpg" alt="" /><br />AttackonTitan2_FinalBattle
                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/Immortals_Fenyx_Rising_300x400.jpg" alt="" /><br />Immortals_Fenyx_Rising
                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/Destiny_2__The_Collection_1x.jpg" alt="" /><br />Destiny_2
                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/Borderlands3_1x.jpg" alt="" /><br />Borderlands3
...
//         </div>
//             <div className="body1">
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/ary_secretofseasons.jpg" alt="" /><br />Ary_secretofseasons
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/Crayta_1x.jpg" alt="" /><br />Crayta
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/cthulhusaveschristmas_1x.jpg" alt="" /><br />Cthulhusaveschristmas
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/elhijo_1x.jpg" alt="" /><br />elhijo
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/entertheguneon_1x.jpg" alt="" /><br />entertheguneon
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/everspace_1x.jpg" alt="" /><br />everspace
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/figment_1x.jpg" alt="" /><br />Figment
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/Gunsport_1x.jpg" alt="" /><br />Gunsport
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/journey-savage_1x.jpg" alt="" /><br />Journey-savage
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/monsterjam_steeltitans_1x.jpg" alt="" /><br />monsterjam_steeltitans
//             </div>
//             <div style={{ textAlign: 'center' }}>
//                 <Button text={'Try Stadia Pro free for 1 month'} />
//                 <br />
...
//             </div>
//             <div className="body2">
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_odyssey_1x.jpg" alt="" /><br />assassinscreed_odyssey
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_origins_1x.jpg" alt="" /><br />assassinscreed_origins
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_syndicate_1x.jpg" alt="" /><br />assassinscreed_syndicate
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_unity_1x.jpg" alt="" /><br />assassinscreed_unity
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/assassinscreed_valhalla_1x.jpg" alt="" /><br />assassinscreed_valhalla
//                 <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/AttackonTitan2_FinalBattle_1x.jpg" alt="" /><br />AttackonTitan2_FinalBattle
...
//         return(
//         <div className="body">
//             <img src="https://www.gstatic.com/stadia/gamers/landing_page/assets/games/outcasters_1x.jpg" alt="" />
//         </div>
//      );
// };
