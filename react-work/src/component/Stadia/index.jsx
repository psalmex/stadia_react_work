    ...
    <div>
      <div style={{ textAlign: "center" }}>
        ...
        >
          ...
          <defs>
            ...
            >
              <stop offset=".099" stop-color="#FF4C1D"></stop>
              <stop offset=".251" stop-color="#F64523"></stop>
              <stop offset=".499" stop-color="#DE3334"></stop>
              <stop offset=".811" stop-color="#B61550"></stop>
            ...
            >
              ...
              <stop offset=".505" stop-color="#F12F3F"></stop>
              <stop offset="1" stop-color="#DC1860"></stop>
            </linearGradient>
          </defs>
        </svg>
        <br />
        ...
        <p>
          Free games. More every month. Keep them as long as you’re a Stadia Pro
          member.<sup>1</sup>
        </p>
      </div>
      ...
      <div className="restyle">
        ...
        <p>
          ...
          <a href="www.stadia.com">Compatible</a> laptops and phones. TVs. You
          have what it takes.
        </p>
      </div>
      <div className="body2">
